...
## create a plan
$PCF_PLAN = New-AzsPlan -Name best-plan -DisplayName "Best-plan for pcf /cf" `
...
New-AzsTenantSubscription -DisplayName "Azure PCF Subscription" -Owner $Global:Service_RM_Account.Context.Account.Id -OfferId $Offer.Id 